...
- **Given** 依赖已完成且输入契约有效
- **When** 通过公开 Use Case/GraphRunner 执行 `GRAPH-CORE-004`
...
python scripts/check_task_card_precision.py --task GRAPH-CORE-004 --strict
